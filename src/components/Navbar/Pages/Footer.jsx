...
import goole from "../../../assets/img/google-play-badge.png";

const Footer = () => {
  return (
   <section className='footer py-3 mt-5'>
     <div className="container footer-wraper py-5 ">
     ...
     <hr />
     <p className='text-center res'> ALL right reserve by biplob kumar </p>
   </section>
  )
}
